$.widget('pretius.enhancedLovItem', {
      ...
      ajaxOptions = {
        ...
        "success": $.proxy(function (pMode, pValuesSent, pData, pTextStatus, pJqXHR) {
          ...
          if (
            ...
            for (i = 0; i < valuesExtra.length; i++) {
              objectTemp = {
                "value": valuesExtra[i],
  ...
  */
  ...
  _popupThCheckboxChange: function (pEvent) {
    ...
    var
      ...
      message = this.C_POPUP_TEXT_ROWS_SELECTED.replace('%0', checkboxes.length), i;
  ...
  */
  ...
  _createItemAjaxButton: function () {
    ...
    button.attr('onclick', 'function(){return false;}');
    button.append(icon);
